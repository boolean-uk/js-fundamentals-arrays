...
const firstColours = colours.shift()
console.log(firstColours)
// 5. Remove the last item from the keys array
const lastKey = keys.pop()
console.log(lastKey)
// 6. Remove Jordan from the countries array
const countriesIndexToRemove = countries.indexOf('Jordan')
if (countriesIndexToRemove !== -1) {
  countries.splice(countriesIndexToRemove, 1)
}
