...
const indexOfFourteen = nums.findIndex((x) => x === 14)

// 3. remove the last 3 elements of the array in one single instruction
const withoutLastThree = nums.splice(0, 6)
...
const includesHundred = nums.indexOf(100) === undefined

// 6. extract the numbers 7, 3, 8 into a new array
const withSevenThreeEight = withoutLastThree.splice(1, 3)
