// DO NOT MODIFY THESE
let nums = [2, 7, 3, 8, 9, 11, 14, 1, 21]
const otherNums = [4, 6, 12, 13]
let numsToMerge = [...nums]
...
nums = [2, 7, 3, 8, 9, 11, 14, 1, 21]
const id7 = nums.indexOf(7)
const id8 = nums.indexOf(8)
const withSevenThreeEight = nums.splice(id7, id8)

// 7. add the numbers0 000000from otherNums to the end of numsToMerge
numsToMerge = [2, 7, 3, 8, 9, 11, 14, 1, 21]
